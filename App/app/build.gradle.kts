...
android {
    namespace = "com.example.campus_pay"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.example.campus_pay"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.compose.material:material-icons-extended") // Add this for extended icons
